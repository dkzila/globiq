...
export const MODULES: ModuleDescriptor[] = [
  ...
  { key: 'exams-syllabus', name: 'Exams & Syllabus', description: 'Country-scoped exams with §36 versioned structures and version-pinned §13 topic-linked SyllabusNode trees; exam mappings next', phase: 'P3', session: 'P3-S1…S3', status: 'in_progress' },
