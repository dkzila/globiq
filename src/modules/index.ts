...
export const MODULES: ModuleDescriptor[] = [
  ...
  { key: 'exam-mapping', name: 'Exam Mapping', description: '§8 requirement-layer mappings (one unit, many depths), public coverage reads, multi-exam union & deduplication engine', phase: 'P3', session: 'P3-S3…S5', status: 'in_progress' },
