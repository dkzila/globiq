...
export const MODULES: ModuleDescriptor[] = [
  ...
  { key: 'exams-syllabus', name: 'Exams & Syllabus', description: 'Country-scoped exams with §36 versioned structures (Exam + ExamVersion); SyllabusNode trees next', phase: 'P3', session: 'P3-S1…S2', status: 'in_progress' },
