...
export const PHASES: Phase[] = [
  ...
  { id: 'P3', title: 'Exams & Combination Engine', scope: 'Exams, syllabus, mappings, multi-exam union', sessions: 5, status: 'done' },
  { id: 'P4', title: 'Search, SEO & Homepages', scope: 'Search, country homepages, sitemaps', sessions: 5, status: 'current' },
