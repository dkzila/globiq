 ...
 * header's Sign-in anchor #account). The real product surface (§34 country
 * homepages, §33 topic landings) is the default experience from P4-S2 —
...
export function ConsoleView({ onBackHome }: ConsoleViewProps) {
  ...
  return (
    <div className="space-y-10">
      {/* ---------- Console banner ---------- */}
      <section aria-labelledby="console-heading" className="space-y-3">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h1 id="console-heading" className="text-2xl font-bold tracking-tight sm:text-3xl">
              Build verification surface
            </h1>
            <p className="mt-1 max-w-2xl text-sm text-zinc-600">
              Every module demo from the session history — the same API-first surfaces a future
              mobile client consumes (§4, §39). The real homepage is one click away.
            </p>
          </div>
          <Button
            variant="outline"
